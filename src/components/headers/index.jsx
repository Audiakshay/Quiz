  ...
  return (
    <div>
      <div className="flex my-4 px-8 w-full items-center cursor-default">
        <div className="flex items-center gap-2 text-2xl sm:text-xl font-bold bg-white rounded-md px-3 sm:px-1 sm:gap-1 sm:py-1 py-2">
          <div>
            <svg className="h-6 sm:h-4" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex justify-center">
        ...
        <div className="flex items-center">
          <div className="px-4">
            <div className="bg-slate-500 md:w-52 h-3 w-72  rounded-lg">
              <div className="bg-green-500 h-3 md:w-52  rounded-lg" style={{ width: 57.6 * Pages }} />
            </div>
          </div>
          <div>
            {Pages}
